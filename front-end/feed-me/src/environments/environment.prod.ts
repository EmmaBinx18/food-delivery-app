export const environment = {
  production: true,
  firebase: {
    apiKey: "AIzaSyC0NhMfNpKbPGTz1cok0b_zz6rWTtdWffA",
  ...
  mapbox: {
    accessToken: 'pk.eyJ1IjoiZmVlZG1ld2ViYXBwIiwiYSI6ImNrYnYwZ2I4bTAxZTcyd3RiaXJjZnBwdDAifQ.ntcYl61Aujl0cqnYVOznfQ'
  }
};
